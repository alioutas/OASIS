...
**Please upload .bed files, preferably without a header (column names), with the following columns in this order: chr, start, end, id (Max. file size 1GB).**



##### **Example file**
<img src="example_file.png" width="40%">
