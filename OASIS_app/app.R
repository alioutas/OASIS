...
# print the name of the sourced files
sapply(file.sources,basename)
                        ...
                        column(3,
                               ...
                               div(id = "op_select_div_new",
                                   ...
                                   conditionalPanel(
                                     ...
                                     fileInput(inputId = "MS1", "Choose Mainstreet 1", multiple = FALSE,
                                               accept = c(
                                                 "text/csv",
                                                 "text/comma-separated-values,text/plain",
                                                 ".csv",
                                   ...
                                   conditionalPanel(
                                     ...
                                     fileInput(inputId = "MS2", "Choose Mainstreet 2", multiple = FALSE,
                                               accept = c(
                                                 "text/csv",
                                                 "text/comma-separated-values,text/plain",
                                                 ".csv",
                                   ...
                                   conditionalPanel(
                                     ...
                                     fileInput(inputId = "BS1", "Choose Backstreet 1", multiple = FALSE,
                                               accept = c(
                                                 "text/csv",
                                                 "text/comma-separated-values,text/plain",
                                                 ".csv",
                                   ...
                                   conditionalPanel(
                                     ...
                                     fileInput(inputId = "BS2", "Choose Backstreet 2", multiple = FALSE,
                                               accept = c(
                                                 ...
                                                 ".csv",
                                                 ".bed")),
                                     checkboxInput(inputId = "same_BS2", "Backstreet 2 same as Mainstreet 2", FALSE)),
...
server <- function(input, output, session) {
  ...
  appended_oligopaints <- eventReactive(input$append, {
    ...
    append_segments <- function(df, condition, toe_field, street_field, ofq_seq_field = NULL, ofq_barcode_field = NULL) {
      append_string <- ""
      
      if (!is.null(condition)) {
        if (condition == "seq_im") {
          append_string <- paste0(df[[toe_field]], "tt")
        } else if (condition %in% c("toe_seq_im", "default")) {
          append_string <- paste0(df[[street_field]], "tt")
        } else if (condition == "ofq" && !is.null(ofq_seq_field) && !is.null(ofq_barcode_field)) {
          append_string <- paste0(df[[ofq_seq_field]], df[[ofq_barcode_field]], "ttt")
        }
      }
    ...
    barcoded_df_out$appended_oligopaint <- str_c(
      ...
      barcoded_df_out$sequence, "tt",
      append_segments(barcoded_df_out, input$append_streets_bs1, "bs1_toe", "bs1_street", "bs1_ofq_seq_primer", "bs1_ofq_barcode"),
      append_segments(barcoded_df_out, input$append_streets_bs2, "bs2_toe", "bs2_street", "bs2_ofq_seq_primer", "bs2_ofq_barcode"),
    ...
    # max_length <- max(nchar(barcoded_df_out$appended_oligopaint), na.rm = TRUE)
    # 
    # barcoded_df_out <- barcoded_df_out %>% 
    #   mutate(appended_oligopaint = str_pad(appended_oligopaint, max_length, side = "right", pad = "t"))
    #   
  ...
  uni_ms_appended_data <- appened_opsServer(id = 'uni_ms', .data = appended_oligopaints_uni_ms, type = append_streets_uni_ms_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = F)
  uni_bs_appended_data <- appened_opsServer(id = 'uni_bs', .data = appended_oligopaints_uni_bs, type = append_streets_uni_bs_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = input$uni_BS_rc)
  ms1_appended_data <- appened_opsServer(id = 'ms1', .data = appended_oligopaints_ms1, type = append_streets_ms1_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = F)
  ms2_appended_data <- appened_opsServer(id = 'ms2', .data = appended_oligopaints_ms2, type = append_streets_ms2_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = F)
  bs1_appended_data <- appened_opsServer(id = 'bs1', .data = appended_oligopaints_bs1, type = append_streets_bs1_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = input$bs1_rc)
  bs2_appended_data <- appened_opsServer(id = 'bs2', .data = appended_oligopaints_bs2, type = append_streets_bs2_reactive, initial_actsec_data = initial_actsec_data_reactive, append_actsec = input$sec405, initial_sec_data = initial_sec_data_reactive, input_sec_data = input_sec_reactive, bs_rc = input$bs2_rc)
